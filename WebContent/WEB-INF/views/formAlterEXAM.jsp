...
<title>Alterar Examinador</title>
...
<body>
<form action="alteraExam" enctype="multipart/form-data" method="post">
	<p>
		<strong> </strong> <input type="hidden" name="idExaminador"
			value="${buscaId.idExaminador}" required /><br />
	</p>
	<p>
